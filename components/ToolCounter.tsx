  ...
  return (
    <section className="px-6 py-16 md:py-20 bg-[#0f0f23]">
      <div className="mx-auto max-w-4xl">
        <div className="rounded-3xl bg-white/[0.15] p-8 md:p-12 shadow-xl border border-white/[0.25] backdrop-blur-sm">
          {/* Header */}
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl bg-white/[0.15] border border-white/[0.25] p-5 text-center">

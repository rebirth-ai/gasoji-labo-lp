  ...
  return (
    <section className="px-6 py-12 md:py-28 bg-gray-50">
      <div className="mx-auto max-w-7xl">
        <h2 className="mb-16 text-center text-2xl font-black text-gray-900 sm:text-4xl md:text-5xl whitespace-nowrap">
          月額課金 <span className="text-[#FF6B35]">vs</span> GAS無料化
        </h2>

        <div className="grid gap-8 md:grid-cols-2">
          {/* Before */}
          <div className="rounded-3xl bg-white p-8 shadow-lg border border-red-500/30 md:p-10">
            <div className="mb-6 inline-flex rounded-full bg-red-500/10 px-4 py-2 text-sm font-bold text-red-400">
              ❌ SaaS月額課金地獄
            </div>
            <h3 className="mb-6 text-2xl font-black text-gray-900">よくある状態</h3>
          ...
          <div className="rounded-3xl bg-[#FF6B35]/5 p-8 shadow-lg border border-[#FF6B35]/30 ring-2 ring-[#FF6B35]/10 md:p-10">
            ...
            <h3 className="mb-6 text-2xl font-black text-gray-900">完全無料の自由</h3>
            <ul className="space-y-4">
              {[
                'SNS自動投稿',
                'プロジェクト管理',
                ...
                <li key={item} className="flex items-center gap-3 rounded-xl bg-gray-50 p-3">

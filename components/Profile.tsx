          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-2 md:justify-start">
                ...
                <a href="https://note.com/yuyukuma_gasoji" className="rounded-full bg-white/10 p-2.5 hover:bg-white/20 transition-colors" aria-label="note">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none"><rect width="24" height="24" rx="6" fill="#41C9B4"/><path d="M7 8.5h7m-7 3.5h10m-10 3.5h5" stroke="#fff" strokeWidth="1.8" strokeLinecap="round"/></svg>
                </a>

  ...
  return (
    <section className="px-6 py-12 md:py-28 bg-white">
      <div className="mx-auto max-w-4xl">
        <div className="rounded-3xl bg-white p-8 border border-gray-200 md:p-12">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="mb-2 text-2xl sm:text-3xl font-black text-gray-900">
                ゆゆくま
              </h3>
              <p className="mb-1 text-sm font-bold text-gray-600">（通称：GASおじ）</p>
              ...
              <div className="mt-6 grid grid-cols-3 gap-4 max-w-xs mx-auto md:mx-0">
                {[
                  ...
                  <div key={stat.label} className="text-center">
                    ...
                    <div className="text-[10px] sm:text-xs text-gray-600 whitespace-nowrap">{stat.label}</div>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-2 md:justify-start">
                <a href="https://x.com/yuyukuma0810" className="rounded-full bg-gray-100 p-2.5 text-gray-500 hover:bg-gray-100 hover:text-gray-900 transition-colors" aria-label="X (Twitter)">
                ...
                <a href="https://www.threads.net/@yuyukuma0810" className="rounded-full bg-gray-100 p-2.5 text-gray-500 hover:bg-gray-100 hover:text-gray-900 transition-colors" aria-label="Threads">
                ...
                <a href="https://www.instagram.com/yuyukuma0810" className="rounded-full bg-gray-100 p-2.5 text-gray-500 hover:bg-gray-100 hover:text-gray-900 transition-colors" aria-label="Instagram">
                ...
                <a href="https://www.tiktok.com/@yuyukuma0810" className="rounded-full bg-gray-100 p-2.5 text-gray-500 hover:bg-gray-100 hover:text-gray-900 transition-colors" aria-label="TikTok">
